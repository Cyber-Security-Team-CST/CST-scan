...
______________.___._______________________________    _____________________________  ____ _____________.___________________.___. ______________________   _____      _____   
\_   ___ \__  |   |\______   \_   _____/\______   \  /   _____/\_   _____/\_   ___ \|    |   \______   \   \__    ___/\__  |   | \__    ___/\_   _____/  /  _  \    /     \  
/    \  \//   |   | |    |  _/|    __)_  |       _/  \_____  \  |    __)_ /    \  \/|    |   /|       _/   | |    |    /   |   |   |    |    |    __)_  /  /_\  \  /  \ /  \ 
\     \___\____   | |    |   \|        \ |    |   \  /        \ |        \\     \___|    |  / |    |   \   | |    |    \____   |   |    |    |        \/    |    \/    Y    \
 \______  / ______| |______  /_______  / |____|_  / /_______  //_______  / \______  /______/  |____|_  /___| |____|    / ______|   |____|   /_______  /\____|__  /\____|__  /
        \/\/               \/        \/         \/          \/         \/         \/                 \/                \/                           \/         \/         \/ 


                          .__                 ____ 
___  __ ___________  _____|__| ____   ____   /_   |
\  \/ // __ \_  __ \/  ___/  |/  _ \ /    \   |   |
 \   /\  ___/|  | \/\___ \|  (  <_> )   |  \  |   |
  \_/  \___  >__|  /____  >__|\____/|___|  /  |___|
           \/           \/               \/        
...
def run_nmap_vuln_scan(ip, port, timeout):
    command = f"nmap -sV -p {port} --script vuln {ip}"
    try:
        process = subprocess.run(
            command,
            shell=True,
...
def main():
    ...
    with ThreadPoolExecutor(max_workers=args.threads) as executor:
        ...
        with tqdm(total=len(futures_service), desc="Определение сервисов") as pbar:
            for future in as_completed(futures_service):
                ...
                # Запуск nmap с использованием скрипта vuln
                future_vuln = executor.submit(run_nmap_vuln_scan, ip, port, args.timeout)
        ...
        with tqdm(total=len(futures_vuln), desc="Сканирование уязвимостей") as pbar:
